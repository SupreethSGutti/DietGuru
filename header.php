...
<div id="loader">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.html"><img src="images/logo_main_white.jpg" alt="" style="height: 51px;"></a> </div>
      <div class="head-info">
        <ul>
          ...
          <li> <i class="fa fa-envelope-o"></i>
            <p>initializers@sirmvit.edu<br>
          </li>
          <li> <i class="fa fa-map-marker"></i>
            <p>Sir M Visvesvaraya institute of technology Krishnadevarayanagar, 
              hunsamaranahalli International airport road, Bengaluru -562157</p>
          </li>
